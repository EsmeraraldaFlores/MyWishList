...
import com.example.mywishlist.ListActivity
import com.example.mywishlist.R
import com.example.mywishlist.databinding.FragmentLoginBinding
import com.example.mywishlist.viewModel.LoginViewModel
...
class LoginFragment : Fragment() {
    ...
    private fun requestLogin() {
        viewModel.requestLogin(binding.etEmail.text.toString(),
